...
if ( strpos( dt_get_url_path(), 'zume_app' ) !== false || dt_is_rest() ){
    Zume_Public_Heatmap_Practitioner::instance();
}

class Zume_Public_Heatmap_Practitioner extends DT_Magic_Url_Base
{
    ...
    public function endpoint( WP_REST_Request $request ) {
        ...
        switch ( $action ) {
            ...
            case 'a0':
            case 'world':
                $list = Zume_App_Heatmap::query_practitioner_grid_totals( $action );
            ...
            case 'grid_data':
                $grid_totals = Zume_App_Heatmap::query_practitioner_grid_totals();
