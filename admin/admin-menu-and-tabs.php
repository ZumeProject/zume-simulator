...
/**
 * Class Zume_Simulator_Menu
 */
class Zume_Simulator_Menu {

    public $token = 'zume_simulator';
    public $page_title = 'Zúme Critical Path';

    private static $_instance = null;

    /**
     * Zume_Simulator_Menu Instance
     *
     * Ensures only one instance of Zume_Simulator_Menu is loaded or can be loaded.
     *
     * @since 0.1.0
     * @static
     * @return Zume_Simulator_Menu instance
     */
    ...
    public function __construct() {
        ...
        $this->page_title = __( 'Zúme Critical Path', 'zume-simulator' );
    }
    ...
    public function content() {
        ...
        <div class="wrap">
            ...
            switch ( $tab ) {
                case 'general':
                    $object = new Zume_Simulator_Tab_General();
                    $object->content();
                    break;
                case 'second':
                    $object = new Zume_Simulator_Tab_Second();
                    $object->content();
                    break;
                default:
                    break;
...
/**
 * Class Zume_Simulator_Tab_General
 */
class Zume_Simulator_Tab_General {
    public function content() {
        ?>
    ...
    public function main_column() {
        $token = Zume_Simulator_Menu::instance()->token;
...
/**
 * Class Zume_Simulator_Tab_Second
 */
class Zume_Simulator_Tab_Second {
    public function content() {
        ?>
